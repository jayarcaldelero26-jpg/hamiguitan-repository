      ...
      <div className="h-screen overflow-hidden bg-[#020817]">
        <div className="flex h-full">
          <motion.aside
            ...
            className="h-full shrink-0 overflow-hidden border-r p-5 flex flex-col
            bg-[linear-gradient(180deg,#03121d_0%,#071c2a_55%,#061724_100%)]
            border-cyan-400/15"
          ...
          >
            ...
            <div className="mt-auto pt-5">
              ...
              <button
                ...
                className={`mt-3 w-full flex items-center gap-2 px-3 py-3 rounded-2xl bg-red-500/10 text-white border border-red-300/15 hover:bg-red-500/15 transition ${
                  collapsed ? "justify-center" : ""
                }`}
              >
          ...
          <main className={`flex-1 h-full overflow-y-auto transition-colors duration-300 ${pageBg}`}>
