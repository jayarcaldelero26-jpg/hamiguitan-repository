...
import DeferredPublicAuthRedirectGate from "@/app/components/public/DeferredPublicAuthRedirectGate";
import HeroCarousel from "@/app/components/public/HeroCarousel";
import LatestPublicDocumentsSection from "@/app/components/public/LatestPublicDocumentsSection";
...
export default function Home() {
  return (
    <PublicShell>
      <HeroCarousel />
      <DeferredPublicAuthRedirectGate />
      ...
      <section className="border-b border-[var(--public-border)] bg-[linear-gradient(180deg,rgba(8,11,18,0.92)_0%,rgba(10,15,22,0.98)_100%)]">
        <div className="public-container py-[24px] md:py-[34px]">
          <Stagger className="grid gap-3 md:grid-cols-2 xl:grid-cols-4" staggerChildren={0.06}>
      ...
      <section className="public-section public-section-light border-b border-[var(--public-border)]">
        <Stagger className="public-container grid gap-[28px] lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          <StaggerItem>
            <div className="max-w-2xl">
              ...
              <Stagger className="mt-6 grid gap-3 sm:grid-cols-3" staggerChildren={0.05}>
                {overviewHighlights.map((item) => (
                  <StaggerItem key={item}>
                    <div className="public-card-soft p-4 text-sm font-medium text-[var(--public-text)]">
                      {item}
                    </div>
                  </StaggerItem>
                ))}
            ...
            <article className="public-card public-panel-highlight p-[28px] md:p-[32px]">
              ...
              <div className="mt-[20px] space-y-3">
                {overviewPoints.map((point) => (
                  <div key={point} className="public-card-soft flex gap-3 p-4">
      ...
      >
        <div className="public-container">
          ...
          <Stagger className="mt-[42px] grid gap-6 lg:grid-cols-2" staggerChildren={0.08}>
      ...
      <section className="public-section public-section-light border-b border-[var(--public-border)]">
        <Stagger className="public-container grid gap-6 lg:grid-cols-[1fr_1fr]">
          <StaggerItem>
            ...
            <article className="public-card public-panel-highlight public-spotlight-card p-[28px] text-white md:p-[34px]">
              ...
              <div className="mt-6 grid gap-3">
                {bookingSteps.map((step, index) => (
                  <div key={step} className="public-card-soft p-4">
      ...
      <section className="public-section public-section-soft border-b border-[var(--public-border)]">
        <div className="public-container">
          <Stagger className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
            <StaggerItem>
              <div className="max-w-2xl">
            ...
            <Stagger className="grid gap-4 md:grid-cols-2" staggerChildren={0.08}>
              <StaggerItem>
        ...
        <div className="public-container">
          <Reveal className="grid gap-8">
            <div className="max-w-3xl">
              ...
              <h2 className="public-h2 mt-[16px]">Latest Minutes and Resolutions</h2>
              <p className="public-body-lg mt-[22px]">
          ...
          <Reveal className="mt-8" delay={0.04}>
            <Suspense fallback={<LatestPublicDocumentsFallback />}>
              <LatestPublicDocumentsSection />
            </Suspense>
          </Reveal>
        </div>
      </section>
...
function LatestPublicDocumentsFallback() {
  return (
    <article className="public-card public-panel-highlight p-6 md:p-8">
      <div className="grid gap-4">
        <div className="public-card-soft h-12 w-40 animate-pulse" />
        <div className="public-card-soft h-[320px] animate-pulse md:h-[420px]" />
      </div>
    </article>
  );
}
