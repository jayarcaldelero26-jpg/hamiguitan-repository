    ...
    <PublicShell>
        ...
        <div className="public-container py-[24px] md:py-[34px]">
          <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
            {highlightItems.map((item) => (
              <article key={item.title} className="public-card-soft public-hover-lift rounded-[24px] p-5">
      ...
      >
        <div className="public-container">
          ...
          <div className="mt-[42px] grid gap-6 lg:grid-cols-2">
            {trailCards.map((trail) => (
              <article
                key={trail.title}
                className="public-card public-spotlight-card public-hover-lift relative overflow-hidden p-[28px] md:p-[34px]"
              >
      ...
      <section className="public-section public-section-light border-b border-[var(--public-border)]">
        <div className="public-container grid gap-6 lg:grid-cols-[1fr_1fr]">
